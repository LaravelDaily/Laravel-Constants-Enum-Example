<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('ticket.edit') }} {{ __('ticket.id') }}: {{ $ticket->id }}
        </h2>
    </x-slot>
                ...
                <div class="overflow-hidden overflow-x-auto p-6 bg-white border-b border-gray-200">
                    ...
                    <form action="{{ route('tickets.store') }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" id="description" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" required>{{ old('description', $ticket->description) }}</textarea>
                        </div>
                        <div class="mt-4">
                        ...
                        <div class="mt-4">
                            <x-button>{{ __('ticket.update') }}</x-button>
                        </div>
                    </form>
                </div>
            </div>
